...
namespace LangerNetwork
{
    ...
    public class QuickBuildMenu
    {
        ...
        // -------------------------------------------------------------------------------
        //FULL DEPLOYMENT
        [MenuItem("NetGame/Quick Build/FULL BUILD/Full Deployment (headless + multi-client) - [linux-osx-win64]", priority = 1)]
        ...
        //WINDOWS
        //headless server + client
        [MenuItem("NetGame/Quick Build/WIN64/Client and Server (headless)", priority = 10)]
        ...
        //headless server
        [MenuItem("NetGame/Quick Build/WIN64/Server (headless)", priority = 11)]
        ...
        //client
        [MenuItem("NetGame/Quick Build/WIN64/Client", priority = 12)]
        ...
        //MAC OSX
        //headless server + client
        [MenuItem("NetGame/Quick Build/OSX/Client and Server (headless)", priority = 20)]
        ...
        //headless server
        [MenuItem("NetGame/Quick Build/OSX/Server (headless)", priority = 21)]
        ...
        //client
        [MenuItem("NetGame/Quick Build/OSX/Client", priority = 22)]
        ...
        [MenuItem("NetGame/Quick Build/Linux/Client and Server (headless)", priority = 30)]
        ...
        //headless server
        [MenuItem("NetGame/Quick Build/Linux/Server (headless)", priority = 31)]
        ...
        //client
        [MenuItem("NetGame/Quick Build/Linux/Client", priority = 32)]
...
#if TEST_MODE
        //OSX
        [MenuItem("NetGame/Quick Build/TEST_MODE/OSX Client and Server (NOT headless)", priority = 0)]
        ...
        //WIN64
        [MenuItem("NetGame/Quick Build/TEST_MODE/Win64 Client and Server (NOT headless)", priority = 1)]
