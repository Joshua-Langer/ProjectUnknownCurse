...
namespace LangerNetwork
{
    ...
    {
        //Return the connection ID of a network Connection as formatted string
        //used in logfiles
        ...
        //Converts a bool value to an int 0 or 1
        //Extends: int
        ...
        //Converts a float into a string and abbreviated it (e.g. 5m or 4d)
        //Extends: string
        ...
        //Removes all previous listeners and adds the new listener (for onClicks etc...)
        //Extends: UnityEvent
        ...
        //HasDuplicates
        //checks if a list containes and duplicates
        //better perfomrance than GroupBy or Dstinct in most cases
